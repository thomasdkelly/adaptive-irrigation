...
#max_irr_list=[75,125,175]

# allocate params
# adapt_inputs = pd.read_csv('./adapt37_inputs.csv')
# row = adapt_inputs.iloc[rep-1]
COST = 1.
#MAXIRR =max_irr_list[(rep-1)%3]
MAXIRR=10000
RISK = 0
CYEAR = 2000
FORECAST = 0
...
def run_10_days_and_reopt(model,cy):
...
pd.DataFrame(results_arr).to_csv('outputs/fixed_converge1.csv', mode='a', header=False)
