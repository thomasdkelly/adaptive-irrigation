...
# allocate params
adapt_inputs = pd.read_csv('./adapt37_cap_extra_inputs (1).csv')
...
pd.DataFrame(results_arr).to_csv('outputs/gs_adapt37_results_cap100.csv', mode='a', header=False)
